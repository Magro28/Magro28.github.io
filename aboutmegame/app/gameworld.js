...
function preload() {
  ...
  game.load.image('background0',
    '../aboutmegame/assets/img/parallax-forest-back-trees.png');
  game.load.image('background1',
    '../aboutmegame/assets/img/parallax-forest-lights.png');
  game.load.image('background2',
    '../aboutmegame/assets/img/parallax-forest-middle-trees.png');
  game.load.image('background3',
    '../aboutmegame/assets/img/parallax-forest-front-trees.png');

  game.load.tilemap('level1', '../aboutmegame/assets/map/level1.json', null,
    Phaser.Tilemap.TILED_JSON);
  game.load.image('tiles-1', '../aboutmegame/assets/map/tiles-1.png');

  //game.load.image('player', 'assets/img/plane.png');

  game.load.spritesheet('beeFly',
    '../aboutmegame/assets/img/enemies/Bee_32x32_Green_Flying_LR.png', 32, 32,
    4);
  game.load.spritesheet('player', '../aboutmegame/assets/img/gripe.run.png', 32,
    32, 16);
}
